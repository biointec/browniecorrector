/************************************************************************************
*    Copyright (C) 2014-2015 Jan Fostier (jan.fostier@ugent.be)                     *    
*                                                                                   *
...
void KmerOverlapTable::parseReadReco(string& read,
                                 vector<pair<Kmer, KmerOverlap> >& kmerBuffer)
{
                                  ...
                                  vector<pair<Kmer, KmerOverlap> >& kmerBuffer)
{
        for (size_t i = 0; i < readBuffer.size(); i++)
                if (settings.getAbundanceMinValue() ==1)
                        ...
                        parseReadReco(readBuffer[i], kmerBuffer);
}
...
{
        const unsigned int& numThreads = settings.getAbundanceMinValue() ==1? settings.getNumThreads():1;
