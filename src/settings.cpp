...
void Settings::printUsage() const
{
        ...
        cout << "  index\t\t build the de Bruijn graph from the reference genoem\n"; 
...
Settings::Settings() :  kmerSize(31),command(Command::none),
        ...
        runSpecificStage(0), graphCorrection(true),
        essaMEMSparsenessFactor(1), bubbleDFSNodeLimit(1000),
        readCorrDFSNodeLimit(1000), covCutoff(0), abundanceMin(1), branchAndBound(true), MarkovFilter(true), essaMEM(true) {}
