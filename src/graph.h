...
public: // FIXME !!! (private)
         ...
         */
        bool flowCorrection(NodeID nodeID);
...
public:
        ...
        bool clipNormalTip2(SSNode startNode );
...
public:
        ...
        double getEstimatedGenomeSize() const{
                return kmerSpectrum.getEstimatedGenomeSize();
        }
        /**
...
public:
        ...
        /*
         * calculates the average of node kmer coverage 
         */
        double getNodeKmerCovAvg();
        /**
